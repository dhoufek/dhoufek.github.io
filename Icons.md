...
## Standalone Icons
Use utilities for height, width and color to adjust as necessary.

**Facebook**
```
<div class="dcf-h-6 dcf-w-6 unl-gray">
...
```
<div class="dcf-h-6 dcf-w-6 unl-gray">
  <svg class="dcf-h-100% dcf-w-100% dcf-fill-current" focusable="false" height="16" width="16" viewBox="0 0 16 17">
    <title>TikTok</title>
    <path d="M14.315 4.971A4.04 4.04 0 0110.269.965H7.655v7.138l-.003 3.91a2.364 2.364 0 01-2.502 2.36 2.355 2.355 0 01-1.082-.332 2.365 2.365 0 01-1.156-1.992 2.367 2.367 0 013.115-2.28V7.117a5.14 5.14 0 00-.753-.055A5.01 5.01 0 001.51 8.745a4.9 4.9 0 00-1.237 2.957 4.894 4.894 0 001.458 3.813 5.012 5.012 0 003.543 1.45c.254 0 .506-.019.753-.056a4.993 4.993 0 002.79-1.395 4.89 4.89 0 001.467-3.48l-.014-5.84a6.608 6.608 0 004.05 1.377v-2.6h-.006z"></path>
  </svg>
</div>
```
...
## Linked Icons
Use utilities for height and width to adjust as necessary.
...
**TikTok**
```
<a class="dcf-d-block dcf-h-6 dcf-w-6" href="#" aria-label="TikTok">
  <svg class="dcf-h-100% dcf-w-100% dcf-fill-current" focusable="false" height="16" width="16" viewBox="0 0 16 17">
    <path d="M14.315 4.971A4.04 4.04 0 0110.269.965H7.655v7.138l-.003 3.91a2.364 2.364 0 01-2.502 2.36 2.355 2.355 0 01-1.082-.332 2.365 2.365 0 01-1.156-1.992 2.367 2.367 0 013.115-2.28V7.117a5.14 5.14 0 00-.753-.055A5.01 5.01 0 001.51 8.745a4.9 4.9 0 00-1.237 2.957 4.894 4.894 0 001.458 3.813 5.012 5.012 0 003.543 1.45c.254 0 .506-.019.753-.056a4.993 4.993 0 002.79-1.395 4.89 4.89 0 001.467-3.48l-.014-5.84a6.608 6.608 0 004.05 1.377v-2.6h-.006z"></path>
  </svg>
</a>
...
**X (formerly Twitter)**
```
<a class="dcf-d-block dcf-h-6 dcf-w-6" href="https://twitter.com/UNLincoln" aria-label="X">
  <svg class="dcf-h-100% dcf-w-100% dcf-fill-current" focusable="false" height="16" width="16" viewBox="0 0 48 48">
    <path d="M28.5 20.3 46 0h-4.1L26.6 17.6 14.5 0H.5l18.3 26.7L.5 48h4.1l16-18.6L33.5 48h14l-19-27.7zm-5.7 6.6-1.9-2.7L6.2 3.1h6.4l11.9 17.1 1.9 2.7L41.8 45h-6.4L22.8 26.9z"></path>
  </svg>
</a>
...
**YouTube**
```
<a class="dcf-d-block dcf-h-6 dcf-w-6" href="https://twitter.com/UNLincoln" aria-label="YouTube">
  <svg class="dcf-h-100% dcf-w-100% dcf-fill-current" focusable="false" height="16" width="16" viewBox="0 0 48 48">
    <path d="M47 12.37a6 6 0 0 0-4.25-4.27C39 7.09 24 7.09 24 7.09s-15 0-18.75 1A6 6 0 0 0 1 12.37C0 16.14 0 24 0 24s0 7.86 1 11.63a6 6 0 0 0 4.25 4.27c3.74 1 18.75 1 18.75 1s15 0 18.75-1A6 6 0 0 0 47 35.63C48 31.86 48 24 48 24s0-7.86-1-11.63zM19.09 31.14V16.86L31.64 24z"></path>
  </svg>
</a>
...
If an [anchor link](https://github.com/unl/wdntemplates/wiki/HTML-Elements#anchors) goes to an external site and does not contain an image or SVG as a child, an icon will be appended to the link to indicate external content to users.